<h1 class="page-header">Daftar Followers</h1>
<div class="row">
	<div class="col-md-12">
		<div class="result-container">
			<ul class="result-list">
				<?php
				if(isset($_GET['id'])){
					$q=mysql_query("select * from follow where target='$_GET[id]'");
				}else{
					$q=mysql_query("select * from follow where target='$_SESSION[login]'");;
				}
				while($h=mysql_fetch_array($q)){
					$qq=mysql_query("select * from user where email='$h[user]'");
